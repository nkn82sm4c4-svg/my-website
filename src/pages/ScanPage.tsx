...
export function ScanPage() {
  ...
  return (
    <section className="relative overflow-hidden bg-ink pt-10 pb-14 text-cream md:pt-16 md:pb-20">
      ...
      <Container className="relative grid grid-cols-1 items-center gap-10 md:grid-cols-2 md:gap-16">
        <div>
          <div className="relative text-center md:text-start">
            <span className="mx-auto grid size-14 md:mx-0 place-items-center rounded-2xl bg-brand font-display text-3xl font-extrabold shadow-float">
              س
            </span>
            <h1 className="mt-4 font-display text-4xl font-extrabold md:text-6xl">منيو QR</h1>
            <p className="mt-2 text-cream/70 md:text-lg">
              العميل يمسح الرمز من طاولته فيفتح موقع {RESTAURANT.name} مباشرة: المنيو والعروض والمكافآت — بدون تحميل أي تطبيق.
            </p>
          </div>

          <div className="relative mx-auto mt-8 max-w-[340px] space-y-3 md:mx-0">
            ...
            <button
              ...
              className="tap flex w-full items-center justify-center gap-1 py-2 text-sm font-medium text-cream/70"
            >
              تخطي إلى الصفحة الرئيسية <ArrowLeft className="size-4" />
            </button>
          </div>

          <div className="relative mx-auto mt-8 max-w-[420px] md:mx-0">
            <p className="mb-3 flex items-center justify-center gap-1.5 text-xs font-semibold text-cream/60 md:justify-start">
        ...
        {/* table tent */}
        <div className="relative order-first mx-auto w-full max-w-[300px] md:order-none md:max-w-[340px]">
