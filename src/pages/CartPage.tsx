...
export function CartPage() {
  ...
  if (order) return <OrderSuccess order={order} stampAdded={stampAdded} onDone={() => setOrder(null)} />
  ...
  return (
    <div className="px-5 pt-3 pb-44">
      <div className="flex items-end justify-between">
        <div>
          <h1 className="text-3xl font-extrabold">سلتك</h1>
      ...
      {/* sticky confirm */}
      <div className="fixed inset-x-0 bottom-[68px] z-30 mx-auto max-w-[480px] px-4 pb-safe">
