...
export function LoyaltyPage() {
  ...
  return (
    <div className="px-5 pt-3 pb-10">
      <h1 className="text-3xl font-extrabold">🎁 برنامج الولاء</h1>
      <p className="text-sm text-muted">أهلًا {state.memberName} — بطاقتك الرقمية دائمًا معك</p>

      <LoyaltyCard className="mt-5" />
      ...
      <div className="grid grid-cols-3 gap-2.5">
        {STEPS.map(({ icon: Icon, title, text }, i) => (
          <div key={title} className="animate-fade-up rounded-2xl bg-white p-3 text-center shadow-card" style={{ animationDelay: `${i * 80}ms` }}>
      ...
      {memberOffer && (
        <>
          <h2 className="mt-8 mb-3 text-xl font-bold">👑 عرض خاص لأعضاء الولاء</h2>
