# سِنمار — Digital Menu, Offers & Loyalty (Demo)

> **منيوك، عروضك، ومكافآتك في مكان واحد**

Prototype لنظام رقمي لمطعم **سِنمار – بريدة**: منيو QR، تجربة 3D للوجبات، اقتراحات Upselling، سلة، وبرنامج ولاء رقمي.
...
**للعرض على المدير:** افتح الموقع على لابتوب؛ على الشاشات العريضة يظهر QR حقيقي بجانب التطبيق، ويمسحه المدير بجواله فيفتح المنيو مباشرة
(`?table=7`). وزر **"للمدير"** أعلى الشاشة يشرح القيمة ويعرض أرقام التجربة مباشرة (متوسط الطلب، وأثر الاقتراحات، ونقاط الولاء)،
...
src/
  ...
  components/  layout / product / three / cart / loyalty / offers / qr / manager / ui
